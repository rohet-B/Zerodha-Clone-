...
const CreateTicket = () => {
  return (
    <div className='container'>
      <div className='row pt-5 mt-5 mb-6'>
        <h1 className='fs-2'>
        ...
        <div className='col-4 p-5 mt-5 mb-2'>
          ...
          <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Zerodha IDF First Bank 3-in-1 Account</a><br/>
          <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Getting Started</a>
        </div>

         <div className='col-4 p-5 mt-5 mb-2'>
          <h4 className='mb-5'>
            <i class="fa-solid fa-user"></i> Account Opening
          </h4>
          <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Login Credentials</a><br/>
          <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Account Modificiation and Segment Addition</a><br/>
         ...
         <div className='col-4 p-5 mt-5 mb-2'>
          ...
          <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Pi and toher platform</a><br/>
         ...
         <div className='col-4 p-5 mt-1 mb-5'>
          <h4 className='mb-5'>
            <i class="fa-solid fa-circle-dollar-to-slot"></i> Coin
          </h4>
